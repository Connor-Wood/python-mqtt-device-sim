...
TEMPERATURE = 20.0
HUMIDITY = 60
MSG_TXT = '{{"temperature2": {temperature},"humidity2": {humidity}}}'
...
def main():
    ...
    # your application
    client = IoTHubDeviceClient.create_from_connection_string("HostName=iotc-fabric-migration.azure-devices.net;DeviceId=test2;SharedAccessKey=")
